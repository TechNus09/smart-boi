...
locations = [
    ["Bright Leaf",945203982798823476],
    ["Wintermist",945204057113505793],
    ["Desert",945204147026800740],
    ["Varaxite City",945204105876488212],
    ["Bosses",945204019834527785]
    ]


skills = ['Combat','Mining','Smithing','Woodcutting','crafting','Fishing','Cooking','Tailoring']

combatRsc=[bright_leaf,wintermist,desert,varaxite_city,bosses]
miningRsc = [
...
Combat_boosts = [["NoBoost",945264095706378290],["Xp Relics",922871203130134528],["Xp Potion",945264171287740486],["World Boost",945264208692543538]]
Mining_boosts = [["NoBoost",945264095706378290],["Pros Neck",945264137246752769],["World Boost",945264208692543538]]
Smithing_boosts = [["NoBoost",945264095706378290],["Inf Hammer",945264297167175681],["Inf Ring",945264261947596842],["World Boost",945264208692543538]]
Woodcutting_boosts = [["NoBoost",945264095706378290],["World Boost",945264208692543538]]
Crafting_boosts = [["NoBoost",945264095706378290],["World Boost",945264208692543538]]
Fishing_boosts = [["NoBoost",945264095706378290],["World Boost",945264208692543538]]
Cooking_boosts = [["NoBoost",945264095706378290],["World Boost",945264208692543538]]
Tailoring_boosts = [["NoBoost",945264095706378290],["World Boost",945264208692543538]]


#noboost_1_ca3:945264045345370122
...
mobs_emoji = {
    'Bat': '<:bat_ca4:922919347423416381>',
    'Slime': '<:slime_ca4:922919366025171056>',
    'Fishing Spider': '<:fishing_spider_ca4:922919348492992552>', 
    'Mashroom': '<:mashroom_ca4:922919357812727818>', 
    'Forest Spider': '<:forest_spider_ca4:922919349013073950>',
    'Forest Bat': '<:forest_bat_ca4:922919348597846046>', 
    'Skeletal Snake': '<:skeletal_snake_ca4:922919364016091176>', 
    'Cave Spider': '<:cave_spider_ca4:922919347914174508>', 
    'Skeletal Bat': '<:skeletal_bat_ca4:922919363957387394>', 
    'Cave Bat': '<:cave_bat_ca4:922919347977064508>',
    'Forest Fiend': '<:forest_fiend_ca4:922919348455239711>', 
    'Rock Fiend': '<:rock_fiend_ca4:922919361776332861>', 
    'Giant Hornet': '<:giant_hornet_ca4:922923881294090310>', 
    'Shadow Flame': '<:shadow_flame_ca4:922919363944804372>', 
    'Shadow Fiend': '<:shadow_fiend_ca3:922924878875754496>',
    'Snow Bat': '<:snow_bat_ca4:922919366125834261>', 
    'Ice Slime': '<:ice_slime_ca4:922919354348236841>', 
    'Snowman': '<:snowman_ca4:922919365777711125>', 
    'Ice Spider': '<:ice_spider_ca4:922919355812036668>', 
    'Ice Fiend': '<:ice_fiend_ca4:922919354088185906>',
    'Ancient Bat': '<:ancient_bat_ca4:922919346806865930>', 
    'Ice Raptor': '<:ice_raptor_ca4:922919354205630565>', 
    'Spectral Flame': '<:spectral_flame_ca4:922919365274398750>', 
    'Phantom Flame': '<:phantom_flame_ca4:922919358353793034>', 
    'Spectral Fiend': '<:spectral_fiend_ca4:922919365148553216>',
    'Phantom Fiend': '<:phantom_fiend_ca4:922919357846269995>', 
    'Ancient Cyclops': '<:ancient_cyclops_ca4:922919347175952414>',
    'Sapphire Scarab': '<:sapphire_scarab_ca4:922919363714105384>', 
    'Scorpion': '<:scorpion_ca3:922925746685632533>', 
    'Raptor': '<:raptor_ca4:922919363386957864>', 
    'Ruby Scarab': '<:ruby_scarab_ca4:922919362032181299>', 
    'Desert Raptor': '<:desert_raptor_ca4:922919348371329085>',
    'Gold Snake': '<:gold_snake_ca4:922919349247955025>', 
    'Brown Snake': '<:brown_snake_ca4:922919347868028948>', 
    'Purple Snake': '<:purple_snake_ca4:922919363311456327>', 
    'Sandstone Golem': '<:sandstone_golem_ca4:922919363198193675>', 
    'Anubis': '<:anubis_ca4:922919347436019772>',
    'Cactus Soldier': '<:cactus_soldier_ca3:922926198240182352>', 
    'Arosite Scarab': '<:arosite_scarab_ca4:922919347494740048>', 
    'Magnetite Scarab': '<:magnetite_scarab_ca4:922919362166407190>', 
    'Anubis Elite': '<:elite_anubis_ca4:922919347951906868>',
    'Luminant Slime': '<:luminant_slime_ca4:922919355946266624>', 
    'Golemite Bat': '<:golemite_bat_ca4:922919351357698079>', 
    'Golemite Fiend': '<:golemite_fiend_ca4:922919353207382079>', 
    'Baby Dragon': '<:baby_dragon_ca4:922919347494744105>',
    'War Bat': '<:war_bat_ca4:922919365995810836>', 
    'Rock Demon': '<:rock_demon_ca4:922919363508600862>', 
    'Ice Demon': '<:ice_demon_ca4:922919354151096370>', 
    'Shadow Demon': '<:shadow_demon_ca3:922926354171826247>', 
    'Ancient War Bat': '<:ancient_war_bat_ca4:922919347335335986>',
    'Spinus': '<:spinus_ca4:922919365303750736>', 
    'Reanimated Soul': '<:reanimated_soul_ca3:922927550857105448>', 
    'Mummy': '<:mummy_ca4:922919357976293376>', 
    'Golem': '<:golem_ca4:922919350711779388>', 
    'Umbra': '<:umbra_ca4:922919365840617502>'
    }
...
baits_emojis = {
    'Anchovies': '<:earthworm_ca2:922887338357567499>',
    'Goldfish': '<:earthworm_ca2:922887338357567499>',
    'Mackerel': '<:iceworm_ca2:922887338655354962>',
    'Squid': '<:iceworm_ca2:922887338655354962>',
    'Sardine': '<:corpseworm:922887338269499414>',
    'Eel': '<:toxic_worm_ca2:922887339037044756>',
    'Anglerfish': '<:sandworm_ca2:922887338848296970>',
    'Trout': '<:beetle_ca2:922887338412097656>',
    'Trout+Jellyfish': '<:beetle_ca2:922887338412097656>',
    'Bass': '<:grasshopper_ca2:922887338810548265>',
    'Bass+Herringbone': '<:grasshopper_ca2:922887338810548265>',
    'Tuna': '<:wasp_ca2:922887339070619708>',
    'Lobster': '<:scallop_ca2:922887338756030515>',
    'Lobster+SeaTurtle': '<:scallop_ca2:922887338756030515>',
    'Manta Ray': '<:crab_ca2:922887338567286784>',
    'Shark': '<:bass_ca2:922873492058284094>',
    'Shark+Orca': '<:bass_ca2:922873492058284094>',
    'Shark+Orca+GiantSquid': '<:bass_ca2:922873492058284094>',
    }

rsc_emojis = {
    'Anchovies+Goldfish': [ 947540424556421171, '<:anchovies_goldfish_ca2:947540424556421171>'],
    'Magic Essence': [ 946207478012580001, '<:magic_essence:946207478012580001>'],
    'Tin Ore': [ 922854986357043280, '<:tin_ore_ca1:922854986357043280>'],
    'Copper Ore': [ 922855022180577290, '<:copper_ore_ca1:922855022180577290>'],
    'Iron Ore': [ 922855050156585020, '<:iron_ore_ca1:922855050156585020>'],
    'Salt': [ 922855080099729429, '<:salt_ca1:922855080099729429>'],
    'Coal': [ 922855065990099004, '<:coal_ca1:922855065990099004>'],
    'Silver Ore': [ 922855652198592586, '<:silver_ore_ca1:922855652198592586>'],
    'Crimsteel Ore': [ 922855136513126460, '<:crimsteel_ore_ca1:922855136513126460>'],
    'Gold Ore': [ 922855152073981952, '<:gold_ore_ca1:922855152073981952>'],
    'Pink Salt': [ 922855174563831829, '<:pink_salt_ca1:922855174563831829>'],
    'Mythan Ore': [ 922855187343884341, '<:mythan_ore_ca1:922855187343884341>'],
    'Sandstone': [ 922855639816994836, '<:sandstone_ca1:922855639816994836>'],
    'Cobalt Ore': [ 922855201956823080, '<:cobalt_ore_ca1:922855201956823080>'],
    'Varaxium': [ 922855217937133568, '<:varaxium_ca1:922855217937133568>'],
    'Black Salt': [ 922855247943204865,'<:black_salt_ca1:922855247943204865>'],
    'Bronze Bar': [ 922855760193531904, '<:bronze_bar_ca1:922855760193531904>'],
    'Iron Bar': [ 922855781030842409, '<:iron_bar_ca1:922855781030842409>'],
    'Steel Bar': [ 922855918633377802, '<:steel_bar_ca1:922855918633377802>'],
    'Crimsteel Bar': [ 922855814669156442, '<:crimsteel_bar_ca1:922855814669156442>'],
    'Silver Bar': [ 922855844989784074, '<:silver_bar_ca1:922855844989784074>'],
    'Gold Nugget': [ 922865224091070555, '<:gold_nugget_ca1:922871008489246721>'],
    'Gold Bar': [ 922855856901586994, '<:gold_bar_ca1:922855856901586994>'],
    'Mythan Bar': [ 922855882117775360, '<:mythan_bar_ca1:922855882117775360>'],
    'Cobalt Bar': [ 922855936161349653, '<:cobalt_bar_ca1:922855936161349653>'],
    'Varaxite Bar': [ 922855948719108126, '<:varaxite_bar_ca1:922855948719108126>'],
    'Pine Log': [ 922856057909420072, '<:pine_log_ca1:922856057909420072>'],
    'Dead Log': [ 922856079233269780, '<:dead_log_ca1:922856079233269780>'],
    'Birch Log': [ 922856103849623702, '<:birch_log_ca1:922856103849623702>'],
    'Applewood': [ 922856116017299466, '<:applewood_ca1:922856116017299466>'],
    'Willow Log': [ 922856157587058688,'<:willow_log_ca1:922856157587058688>'],
    'Oak Log': [ 922856175345754163, '<:oak_log_ca1:922856175345754163>'],
    'Chestnut Log': [ 922856194002001960, '<:chestnut_log_ca1:922856194002001960>'],
    ...
    'Wealth Relic': [ 922871202773618768, '<:wealth_relic_ca1:922871202773618768>'],
    'Power Relic': [ 922871202907828254, '<:power_relic_ca1:922871202907828254>'],
    'Nature Relic': [ 922871202979135531, '<:nature_relic_ca1:922871202979135531>'],
    'Fire Relic': [ 922857046913716286, '<:fire_relic_ca1:922857046913716286>'],
    'Damage Relic': [ 922857046762721281, '<:damage_relic_ca1:922857046762721281>'],
    'Leeching Relic': [ 922871203079794698, '<:leeching_relic_ca1:922871203079794698>'],
    'Experience Relic': [ 922871203130134528, '<:experience_relic_ca1:922871203130134528>'], 
    'Cursed Relic': [ 922857046934708235, '<:cursed_relic_ca1:922857046934708235>'],
    'Ice Relic': [ 936964378517975040, '<:ice_relic_ca3:936964378517975040>'],
    'Anchovies': [ 922873492137992222, '<:anchovies_ca2:922873492137992222>'],
    'Goldfish': [ 922873492536442940, '<:goldfish_ca2:922873492536442940>'],
    'Mackerel': [ 922873492821672027, '<:mackerel_ca2:922873492821672027>'],
    'Squid': [ 922873493312376862, '<:squid_ca2:922873493312376862>'],
    'Sardine': [ 922873493060743189, '<:sardine_ca2:922873493060743189>'],
    'Eel': [ 922873492272189451, '<:eel_ca2:922873492272189451>'],
    'Anglerfish': [ 922873492293177405, '<:anglerfish_ca2:922873492293177405>'],
    'Trout': [ 922873493345959996, '<:trout_ca2:922873493345959996>'],
    'Trout+Jellyfish': [ 922876044111937548, '<:trout_jellyfish_ca2:922876044111937548>'],
    'Bass': [ 922873492058284094, '<:bass_ca2:922873492058284094>'],
    'Bass+Herringbone': [ 922876044036407326, '<:bass_bones_ca2:922876044036407326>'],
    'Tuna': [ 922873493475950672, '<:tuna_ca2:922873493475950672>'],
    'Lobster': [ 922873492813271051, '<:lobster_ca2:922873492813271051>'],
    'Lobster+SeaTurtle': [ 922876043780575233, '<:lobster_seaturtle_ca2:922876043780575233>'],
    'Manta Ray': [ 922873492691644447, '<:manta_ray_ca2:922873492691644447>'],
    'Shark': [ 922873493115248721, '<:shark_ca2:922873493115248721>'],
    'Shark+Orca': [ 922876044158070825, '<:shark_orca_ca2:922876044158070825>'],
    'Shark+Orca+GiantSquid': [ 922876044342624376, '<:shark_orca_giantsquid_ca2:922876044342624376>'],
    'Cooked Anchovies': [ 922873530536824843, '<:cooked_anchovies_ca2:922873530536824843>'],
    'Cooked Mackerel': [ 922873531073716235, '<:cooked_mackerel_ca2:922873531073716235>'],
    'Cooked Squid': [ 922873531165982801, '<:cooked_squid_ca2:922873531165982801>'],
    'Cooked Sardine': [ 922873531337957427, '<:cooked_sardine_ca2:922873531337957427>'],
    'Cooked Eel': [ 922873530943668235, '<:cooked_eel_ca2:922873530943668235>'],
    'Cooked Anglerfish': [ 922873530897559602, '<:cooked_anglerfish_ca2:922873530897559602>'],
    'Cooked Trout': [ 922873531698647101, '<:cooked_trout_ca2:922873531698647101>'],
    'Cooked Bass': [ 922873530725568592, '<:cooked_bass_ca2:922873530725568592>'],
    'Cooked Tuna': [ 922873531803533382, '<:cooked_tuna_ca2:922873531803533382>'],
    'Cooked Lobster': [ 922873530973036574, '<:cooked_lobster_ca2:922873530973036574>'],
    'Cooked Sea Turtle': [ 922873531547664384, '<:cooked_sea_turtle_ca2:922873531547664384>'],
    'Cooked Manta Ray': [ 922873531195355176, '<:cooked_manta_ray_ca2:922873531195355176>'],
    'Cooked Shark': [ 922873531501510686, '<:cooked_shark_ca2:922873531501510686>'],
    'Cooked Orca': [ 922873530994003989, '<:cooked_orca_ca2:922873530994003989>'],
    'Cooked Giant Squid': [ 922873530943680532, '<:cooked_giant_squid_ca2:922873530943680532>'],
    'Wand': [ 936964379080024135,'<:wand_ca3:936964379080024135>'],
    'Paper': [ 936964378773831721, '<:paper_ca3:936964378773831721>'],
    'Book': [ 936964379092594718, '<:book_ca3:936964379092594718>'],
    'Ember Tome': [ 936964378283114506, '<:ember_tome_ca3:936964378283114506>'],
    'Leech Tome': [ 936964378891264001, '<:leech_tome_ca3:936964378891264001>'],
    'Haunt Tome': [ 936964378002071573, '<:haunt_tome_ca3:936964378002071573>'],
    'Fire Staff': [ 936964377867862048, '<:fire_staff_ca3:936964377867862048>'],
    'Ice Staff': [ 936964378606075934, '<:ice_staff_ca3:936964378606075934>'],
    'Nature Staff': [ 936964379067437096, '<:nature_staff_ca3:936964379067437096>'],
    'Cursed Staff': [ 936964377964322857, '<:cursed_staff_ca3:936964377964322857>'],
    'Icicle Tome': [ 936964378689957958, '<:icicle_tome_ca3:936964378689957958>'],
    'Ignite Tome': [ 936964378748674090, '<:ignite_tome_ca3:936964378748674090>'],
    'Drain Tome': [ 936964378077564988, '<:drain_tome_ca3:936964378077564988>'],
    'Curse Tome': [ 936964377867874305, '<:curse_tome_ca3:936964377867874305>'],
    'Freeze Tome': [ 936964378337615912,  '<:freeze_tome_ca3:936964378337615912>'],
    'Inferno Tome': [ 936964378568318977, '<:inferno_tome_ca3:936964378568318977>'],
    'Consume Tome': [ 936964377565876286, '<:consume_tome_ca3:936964377565876286>'],
    'Torture Tome': [ 936964379147124786, '<:torture_tome_ca3:936964379147124786>'],
    'Blizzard Tome': [ 936964377712676906,'<:blizzard_tome_ca3:936964377712676906>']
    }
cancel_emoji = '<:cancel_ca3:945099626447528026>'

boosts_emojis = {
                "NoBoost":'<:noboost_1_ca3:945264045345370122>',
                "Inf Hammer":'<:infhammer_ca3:945264297167175681>',
                "Inf Ring":'<:infring_ca3:945264261947596842>',
                "Xp Relics":'<:experience_relic_ca1:922871203130134528>',
                "Xp Potion":'<:potion_ca3:945264171287740486>',
                "Pros Neck":'<:pros_neck_ca3:945264137246752769>',
                "World Boost":'<:worldboost_ca3:945264208692543538>'
                }
